...
const retroEffect = new GlslEffect('retro', {
		uniforms: new Map([
			[ 'fontColor', new THREE.Uniform(new THREE.Vector3(236/255, 240/255, 193/255))], 
			//[ 'fontColor', new THREE.Uniform(new THREE.Vector3(200/255, 255/255, 110/255))], 
			//rgb(35, 37, 43)rgb(15, 17, 27)
			//35/255, 17/255, 27/255
			//[ 'backgroundColor', new THREE.Uniform(new THREE.Vector3(15/255, 17/255, 27/255))], 
			[ 'backgroundColor', new THREE.Uniform(new THREE.Vector3(12/255, 10/255, 27/255))], 
			//[ 'backgroundColor', new THREE.Uniform(new THREE.Vector3(0.0, 0.05, 0.0))], 
			//[ 'chromaColor', new THREE.Uniform(1.0)], 
			[ 'chromaColor', new THREE.Uniform(0.75)], 
			//[ 'staticNoise', new THREE.Uniform(0.2)], 
			[ 'staticNoise', new THREE.Uniform(0.15)], 
